...
class MeList extends React.Component {
  ...
  render() {
    ...
    const isFriendsPath = (this.props.history.location.pathname === "/channels/@me")

    return <div className="me-list">
      <div id="search-blur"></div>
      <Link to="/channels/@me" className={isFriendsPath ? "active" : ""}>
        ...
        {this.props.incoming.length > 0 ?
          <div className="friends-link-notifications">{this.props.incoming.length}</div>
          : null}
      </Link>
